...
import fr.miage.toulouse.menuismiage.gestionaffairescommerciaux.core.metier.AffairesMetierLocal;
...
public class ServiceAffaires implements ServiceAffairesLocal {
    ...
    public Object modifierStatut(String id, String content) throws StatutAffaireInvalide {
        ...
        return "{ \"status\" : \""+this.affairesMetier.modifierStatut(Integer.parseInt(id), statut)+"\" }";
    }
}
